  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <Card className="bg-white p-5 border border-gray-100 text-center space-y-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <Card className="lg:col-span-7 bg-white p-6 border border-gray-100 space-y-4">
        ...
        <Card className="lg:col-span-5 bg-gradient-to-br from-rose-50/80 via-purple-50/80 to-emerald-50/80 p-6 border border-purple-100 space-y-4">
